<section class="d-flex justify-content-between align-items-center py-1 bg-white">
    ...
    <div>
        <nav class="d-flex align-items-center">
            ...
            <span class="position-relative mt-1 me-1" style="cursor:pointer" data-toggle="modal" data-target="#cartModal">
                ...
                if (isset($_SESSION['userType']) == false) {
                    ...
                    <div>
                        <img src=<?= $imgSrc ?> id="dropdownMenuButton" class="rounded-circle dropdown-toggle"
                            style="width: 35px; cursor:pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" />
