...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($pharmacy_id_list as $id) {
        ...
        if ($cartItem_row_count > 0) {
            ...
            $sql_setOrder = "INSERT INTO orders (`order_code`,`pharmacy_id`,`cust_id`,`contact_no`,`total_items`,`sale_amount`,`tax`,`shipping_cost`,`shipping_address`,`delivery_option`,`delivery_status`,`payment_method`,`order_type`) VALUES ('$orderCode', $id, $user_id,'',$cartItem_row_count,$total_sale_amount,'','','','','pending','$payment_method','online')";
